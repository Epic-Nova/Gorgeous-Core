...
<=============================--- Class Info ---============================>
<-----------------------------=== Quick Info ===---------------------------->
| Display Name: Gorgeous Cascade Feedback Effect
| Functional Name: UGorgeousCascadeFeedbackEffect
| Parent Class: UGorgeousFeedbackEffect
| Class Suffix: -
| Author: Nils Bergemann
<--------------------------------------------------------------------------->
<--------------------------=== Class Description ===------------------------>
| Feedback effect that spawns a Cascade (legacy particle) emitter at the
| feedback location or attached to the target.
<--------------------------------------------------------------------------->
<==========================================================================>
*/
UCLASS(BlueprintType, EditInlineNew, DefaultToInstanced,
	meta = (
		...
		DocumentationAPI = "https://gorgeous.simsalabim.studio/docs/gorgeous-core/Runtime/GeneralSystems/FeedbackEffects/Effects/GorgeousCascadeFeedbackEffect",
...
public:
	...
	/**
	 * Spawns the configured Cascade emitter at the feedback location or attached to the target.
	 *
	...
	/**
	 * Determines whether this effect is enabled and has a particle system configured.
	 *
