...
<=============================--- Class Info ---============================>
<-----------------------------=== Quick Info ===---------------------------->
| Display Name: Gorgeous Common Widget Switcher
| Functional Name: UGorgeousCommonWidgetSwitcher
| Parent Class: UCommonAnimatedSwitcher
| Class Suffix: -
| Author: Nils Bergemann
<--------------------------------------------------------------------------->
<--------------------------=== Class Description ===------------------------>
| Provides runtime functionality for Gorgeous Common Widget Switcher.
<--------------------------------------------------------------------------->
<==========================================================================>
*/
UCLASS(
	meta = (
		...
		DocumentationAPI = "https://gorgeous.simsalabim.studio/docs/gorgeous-core/Runtime/GeneralSystems/CommonUIFoundation/Widgets/GorgeousCommonWidgetSwitcher",
...
class GORGEOUSCORERUNTIME_API UGorgeousCommonWidgetSwitcher : public UCommonAnimatedSwitcher, public IGorgeousUIWidget_I
{
	...
	UGorgeousCommonWidgetSwitcher(const FObjectInitializer& ObjectInitializer);
