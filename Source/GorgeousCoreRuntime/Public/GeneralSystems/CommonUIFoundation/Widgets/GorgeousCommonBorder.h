...
<=============================--- Class Info ---============================>
<-----------------------------=== Quick Info ===---------------------------->
| Display Name: Gorgeous Common Border
| Functional Name: UGorgeousCommonBorder
| Parent Class: UCommonBorder
| Class Suffix: -
...
class GORGEOUSCORERUNTIME_API UGorgeousCommonBorder : public UCommonBorder, public IGorgeousUIWidget_I
{
	...
	UGorgeousCommonBorder(const FObjectInitializer& ObjectInitializer);
