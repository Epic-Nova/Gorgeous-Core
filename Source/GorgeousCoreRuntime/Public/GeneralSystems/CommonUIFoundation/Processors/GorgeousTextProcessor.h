...
<=============================--- Class Info ---============================>
<-----------------------------=== Quick Info ===---------------------------->
| Display Name: Gorgeous Text Processor
| Functional Name: UGorgeousTextProcessor
...
UCLASS(
	meta = (
		...
		DocumentationAPI = "https://gorgeous.simsalabim.studio/docs/gorgeous-core/Runtime/GeneralSystems/CommonUIFoundation/Processors/GorgeousTextProcessor",
...
class GORGEOUSCORERUNTIME_API UGorgeousTextProcessor : public UGorgeousUIProcessor
{
	...
	// Initializes the processor for text-based widgets.
	UGorgeousTextProcessor();

	//<============================--- Overrides ---============================>
	#pragma region Overrides
public:
	// Routes a signal payload to a text-based widget.
	virtual void OnSignalReceived(UObject* Widget, FGameplayTag SignalTag, const FInstancedStruct& Payload) override;

	// Applies resolved theme values to a text-based widget.
