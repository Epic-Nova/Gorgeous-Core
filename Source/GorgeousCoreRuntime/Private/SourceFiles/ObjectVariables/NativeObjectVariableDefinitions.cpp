...
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Queue, TArray<bool>, Boolean)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Queue, TArray<FRotator>, Rotator)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Queue, TArray<FText>, Text)

UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Stack, TArray<bool>, Boolean)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Stack, TArray<FRotator>, Rotator)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Stack, TArray<FText>, Text)

UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Deque, TArray<bool>, Boolean)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Deque, TArray<FRotator>, Rotator)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_CUSTOM_MULTIPLE_INTERFACE_IMPLEMENTATION(Deque, TArray<FText>, Text)
...
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_GENERAL_INTERFACE_IMPLEMENTATION(float, Float, 0.0)
UE_DECLARE_OBJECT_VARIABLE_DEFAULT_GENERAL_INTERFACE_IMPLEMENTATION(double, Double, 0.0)
