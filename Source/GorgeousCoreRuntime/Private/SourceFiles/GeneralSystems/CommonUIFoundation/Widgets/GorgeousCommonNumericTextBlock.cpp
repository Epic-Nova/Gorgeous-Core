...
UGorgeousCommonNumericTextBlock::UGorgeousCommonNumericTextBlock(const FObjectInitializer& ObjectInitializer)
...
void UGorgeousCommonNumericTextBlock::ReleaseSlateResources(bool bReleaseChildren)
{
