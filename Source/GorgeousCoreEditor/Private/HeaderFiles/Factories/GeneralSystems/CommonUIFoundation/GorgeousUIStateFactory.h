...
#include "GorgeousUIStateFactory.generated.h"
//<-------------------------------------------------------------------------->

/**
 * Factory class responsible for creating instances of UGorgeousUIState_DA.
 * The configuration is encapsulated using FGorgeousFactoryInfo_S, which is passed to the base class.
 *
 * @author Nils Bergemann
 */
UCLASS()
class UGorgeousUIStateFactory : public UGorgeousFactory
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UGorgeousUIStateFactory()
	{
		SetFactoryInformation(FGorgeousFactoryInfo_S(UGorgeousUIState_DA::StaticClass(), true, false, true, false,
