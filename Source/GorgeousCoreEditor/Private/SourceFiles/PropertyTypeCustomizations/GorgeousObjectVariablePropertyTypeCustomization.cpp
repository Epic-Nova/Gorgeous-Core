...
//=============================================================================
// FGorgeousObjectVariablePropertyTypeCustomization Implementation
//=============================================================================
...
void FGorgeousObjectVariablePropertyTypeCustomization::CustomizeHeader(const TSharedRef<IPropertyHandle> PropertyHandle,
...
void FGorgeousObjectVariablePropertyTypeCustomization::CustomizeChildren(const TSharedRef<IPropertyHandle> PropertyHandle,
...
void FGorgeousObjectVariablePropertyTypeCustomization::GenerateObjectVariableWidget()
{
	//@TODO
}
...
TSharedRef<SWidget> FGorgeousObjectVariablePropertyTypeCustomization::GenerateEnumDropdown(FText LabelText, const UEnum* EnumType, TFunction<void(TEnum)> OnSelectionChangedCallback)
{
