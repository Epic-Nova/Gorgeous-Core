...
void UGorgeousK2Node_GetObjectVariable::ExpandNode(FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
...
FText UGorgeousK2Node_GetObjectVariable::GetTooltipText() const
{
...
UClass* UGorgeousK2Node_GetObjectVariable::GetConnectedUObjectInstance(const UEdGraphPin* TargetPin)
{
    ...
    if (TargetPin->LinkedTo.Num() > 0)
    {
        ...
        if (UK2Node_VariableGet* VarGetNode = Cast<UK2Node_VariableGet>(LinkedNode))
        {
            ...
            FoundClass = FindObject<UClass>(nullptr, *VarGetNode->Pins[0]->PinType.PinSubCategoryObject->GetName());
